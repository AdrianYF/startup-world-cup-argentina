...
function Panel({ persona, ingresos, onAcreditar, onCerrar }: {
  ...
  return (
    <div className="fixed inset-0 z-30 flex items-end" role="dialog" aria-modal="true">
      ...
      <div className="relative mx-auto w-full max-w-lg rounded-t-2xl border-t border-swc-accent/30 bg-swc-surface px-5 pt-6 pb-8">
        ...
        {yaEntro && ultimo && (
          <p className="mb-4 rounded-xl border border-white/10 bg-white/[0.04] px-4 py-3 text-sm text-gray-300">
            Ya acreditada hoy a las {hora(ultimo.creadoEn)}
