    ...
    >
      <defs>
        <pattern id="guilloche" x="0" y="0" width="40" height="40" patternUnits="userSpaceOnUse">
          <path d="M0,20 Q10,0 20,20 T40,20" stroke="#0c2e4a" strokeWidth="0.5" fill="none" />
          <path d="M0,30 Q10,10 20,30 T40,30" stroke="#0c2e4a" strokeWidth="0.5" fill="none" />
        </pattern>
      </defs>
    ...
    return (
      <div className="inline-flex items-stretch font-mono select-none drop-shadow-lg">
        ...
        <div className="bg-gradient-to-br from-[#75AADB] to-[#4a82b8] rounded-r-lg px-3 py-2 border-2 border-l-0 border-[#0c2e4a]/80 flex items-center justify-center">
          <span className="text-[#0c2e4a] text-sm font-black tracking-widest">AR·26</span>
        </div>
      </div>
    )
  }
      ...
      <div className="relative rounded-2xl border-[3px] border-[#0c2e4a]/90 shadow-[0_25px_70px_-15px_rgba(12,46,74,0.7)] overflow-hidden">
        ...
        <div className="relative flex items-stretch text-[#0c2e4a]">
          ...
          <div className="flex-1 p-7 pt-8">
            ...
            {/* Premio — protagonista */}
            <div className="relative border-y-2 border-dashed border-[#0c2e4a]/40 py-5 my-2">
          ...
          {/* === STUB === */}
          <div className="relative w-28 bg-gradient-to-b from-[#75AADB] via-[#5a93c5] to-[#4a82b8] flex flex-col items-center justify-center p-4 text-center gap-4">
            <GuillochePattern />
