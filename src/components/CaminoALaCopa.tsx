...
function CaminoALaCopa() {
  const whatsapp = content.config.links.whatsapp
        ...
        <div className="grid grid-cols-1 lg:grid-cols-[5fr_6fr] gap-12 lg:gap-10 items-center">
          ...
          <div className="relative order-1 lg:order-2 flex items-center justify-center">
            ...
            <div className="flex flex-col items-center w-full">
              {/* La copa es cliqueable y lleva directo al canal de WhatsApp */}
              <a
                href={whatsapp}
                target="_blank"
                rel="noopener noreferrer"
                aria-label="Unite al canal de WhatsApp de Startup World Cup Argentina (abre en una nueva pestaña)"
                className="group relative block w-full max-w-[720px] aspect-square cursor-pointer"
              >
                <Suspense
                  fallback={
                    <img
              ...
              {/* CTA fuerte al canal de WhatsApp (debajo de la copa) */}
              <div className="-mt-12 sm:-mt-16 flex flex-col items-center text-center">
                <span className="relative inline-flex">
                  ...
                  <a
                    ...
                    target="_blank"
                    rel="noopener noreferrer"
                    aria-label="Enterate antes que nadie en el canal de WhatsApp"
                    className="relative inline-flex items-center gap-2.5 rounded-full bg-[#25D366] hover:bg-[#1ebe5b] text-white font-black text-base sm:text-lg px-7 py-3.5 shadow-[0_12px_30px_-8px_rgba(37,211,102,0.6)] hover:shadow-[0_16px_40px_-8px_rgba(37,211,102,0.8)] [text-shadow:0_1px_2px_rgba(0,0,0,0.25)] transition-all hover:scale-105 active:scale-95"
                  >
                ...
                <p className="mt-3 text-gray-600 text-sm sm:text-base max-w-xs leading-snug">
                  Eventos, lanzamientos y novedades, todo sale primero en el canal.
                </p>
              </div>
            </div>
          </div>
