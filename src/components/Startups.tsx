        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
          ...
          <div>
            ...
            <h2 className="text-5xl lg:text-6xl font-black uppercase mb-6">
              ...
              <span className="text-[#6c5ce7]">TU STARTUP</span>
            </h2>
            ...
            <button
              ...
              className="inline-block bg-[#6c5ce7] hover:bg-[#5848c4] active:scale-95 text-white font-black text-lg px-8 py-3 rounded-full transition-all uppercase tracking-wide cursor-pointer shadow-lg shadow-[#6c5ce7]/30 hover:shadow-[#6c5ce7]/50 hover:scale-105"
            >
